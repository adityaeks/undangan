                                ...
                                <div class="p-3 rounded-2xl bg-[#FDF8F9] border border-rosewood-100 space-y-1 text-left">
                                    <div class="flex items-center justify-between text-[11px] gap-2">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span 
                                                class="px-2 py-0.5 rounded-full text-[9px] font-semibold bg-rosewood-100 text-rosewood-700" 
                                    ...
                                    <p class="text-xs text-rosewood-700 leading-relaxed" x-text="w.message || w.msg"></p>
                                </div>
                            </template>
                        </div>
                    </div>
