    ...
    >
        ...
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-sand-200">
            ...
            <div class="flex items-center gap-2">
                <span class="px-3 py-1.5 rounded-2xl bg-amber-500/10 border border-amber-500/30 text-amber-900 font-bold text-xs flex items-center gap-1.5">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                        ...
                        <div>
                            ...
                            <input type="text" name="groom_name" value="{{ old('groom_name') }}" placeholder="Contoh: Ryan Pratama, S.T." required class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>

                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Panggilan</label>
                                <input type="text" name="groom_nickname" value="{{ old('groom_nickname') }}" placeholder="Ryan" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Urutan Anak</label>
                                <input type="text" name="groom_child_order" value="{{ old('groom_child_order') }}" placeholder="Putra pertama dari" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="text" name="groom_father" value="{{ old('groom_father') }}" placeholder="Bpk. Hendra Pratama" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Ibu</label>
                                <input type="text" name="groom_mother" value="{{ old('groom_mother') }}" placeholder="Ibu Rina Astuti" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>

                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Akun Instagram</label>
                            <input type="text" name="groom_instagram" value="{{ old('groom_instagram') }}" placeholder="@ryanpratama" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                    ...
                    <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                        ...
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Nama Lengkap & Gelar *</label>
                            <input type="text" name="bride_name" value="{{ old('bride_name') }}" placeholder="Contoh: Vanya Alodya, S.Farm." required class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>

                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Panggilan</label>
                                <input type="text" name="bride_nickname" value="{{ old('bride_nickname') }}" placeholder="Vanya" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Urutan Anak</label>
                                <input type="text" name="bride_child_order" value="{{ old('bride_child_order') }}" placeholder="Putri kedua dari" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Ayah</label>
                                <input type="text" name="bride_father" value="{{ old('bride_father') }}" placeholder="Bpk. Wahyu Nugraha" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Ibu</label>
                                <input type="text" name="bride_mother" value="{{ old('bride_mother') }}" placeholder="Ibu Maya Sari" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>

                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Akun Instagram</label>
                            <input type="text" name="bride_instagram" value="{{ old('bride_instagram') }}" placeholder="@vanyaalodya" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="date" name="akad_date" value="{{ old('akad_date') }}" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Waktu Acara</label>
                            <input type="text" name="akad_time" value="{{ old('akad_time') }}" placeholder="08.00 - 10.00 WIB" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Nama Tempat / Gedung</label>
                            <input type="text" name="akad_venue" value="{{ old('akad_venue') }}" placeholder="Masjid Agung Sunda Kelapa" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            ...
                            <input type="text" name="akad_address" value="{{ old('akad_address') }}" placeholder="Jl. Taman Sunda Kelapa No.16, Menteng, Jakarta Pusat" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Link Google Maps (Opsional)</label>
                            <input type="url" name="akad_maps_link" value="{{ old('akad_maps_link') }}" placeholder="https://maps.google.com/..." class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="date" name="resepsi_date" value="{{ old('resepsi_date') }}" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Waktu Acara</label>
                            <input type="text" name="resepsi_time" value="{{ old('resepsi_time') }}" placeholder="11.00 - 14.00 WIB" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Nama Tempat / Gedung</label>
                            <input type="text" name="resepsi_venue" value="{{ old('resepsi_venue') }}" placeholder="Grand Ballroom The Ritz-Carlton" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Alamat Lengkap</label>
                            <input type="text" name="resepsi_address" value="{{ old('resepsi_address') }}" placeholder="Mega Kuningan Barat No.1, Jakarta Selatan" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Link Google Maps (Opsional)</label>
                            <input type="url" name="resepsi_maps_link" value="{{ old('resepsi_maps_link') }}" placeholder="https://maps.google.com/..." class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                    ...
                    <div class="p-4 rounded-2xl bg-sand-50/70 border border-sand-200 space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div>
                                ...
                                <input type="text" name="bank_1_name" value="{{ old('bank_1_name') }}" placeholder="BCA / Mandiri / BRI" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nomor Rekening</label>
                                <input type="text" name="bank_1_number" value="{{ old('bank_1_number') }}" placeholder="1234567890" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Atas Nama (Holder)</label>
                                <input type="text" name="bank_1_holder" value="{{ old('bank_1_holder') }}" placeholder="Nama Pemilik Rekening" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="p-4 rounded-2xl bg-sand-50/70 border border-sand-200 space-y-3">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nama Bank</label>
                                <input type="text" name="bank_2_name" value="{{ old('bank_2_name') }}" placeholder="BNI / BSI / Jenius" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Nomor Rekening</label>
                                <input type="text" name="bank_2_number" value="{{ old('bank_2_number') }}" placeholder="9876543210" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                            <div>
                                <label class="block font-bold text-charcoal-950 mb-1">Atas Nama (Holder)</label>
                                <input type="text" name="bank_2_holder" value="{{ old('bank_2_holder') }}" placeholder="Nama Pemilik Rekening" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="gift_address" rows="2" placeholder="Jl. Kemang Raya No. 12, Mampang Prapatan, Jakarta Selatan (Penerima: Ryan & Vanya - 0812xxxxxxx)" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500"></textarea>
                    </div>
                </div>
                ...
                <div class="rounded-3xl glass-panel border border-sand-200/80 p-6 bg-white/95 shadow-sm space-y-4 text-xs">
                    ...
                    <div class="space-y-3">
                        <div>
                            ...
                            <textarea name="quote_text" rows="3" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">{{ old('quote_text', 'Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang.') }}</textarea>
                        </div>

                        <div>
                            <label class="block font-bold text-charcoal-950 mb-1">Sumber Kutipan</label>
                            <input type="text" name="quote_source" value="{{ old('quote_source', 'QS. Ar-Rum: 21') }}" class="w-full px-4 py-3 rounded-2xl border border-sand-300 bg-white text-xs focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500">
                        </div>
                    </div>
                </div>
