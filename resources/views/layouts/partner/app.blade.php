...
<head>
    ...
    <title>{{ config('app.name', 'KlikMomen') }} - Partner Portal</title>
    ...
    <style>
        ...
        aside ::-webkit-scrollbar-thumb { background: rgba(255, 255, 255, 0.12); border-radius: 9999px; }
...
<body class="h-full bg-sand-100 text-charcoal-900 font-sans antialiased selection:bg-amber-200 selection:text-charcoal-950" x-data="{ sidebarOpen: false }">
    ...
    <div class="min-h-screen">
        ...
        <div class="flex flex-col min-h-screen lg:pl-72">
            ...
            <!-- NAVBAR (ponytail: reuse admin navbar with role-aware badge) -->
            ...
            <!-- FOOTER (ponytail: reuse shared footer) -->
